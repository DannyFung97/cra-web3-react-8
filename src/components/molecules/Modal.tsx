...
import { ModalContainer, ModalBase, ModalHeader, ModalFooter, ModalButtonProps } from '../atoms/Modal'
  ...
  return (
    <ModalContainer isOpen={props.isOpen}>
      <ModalBase isOpen={props.isOpen}>
        <ModalHeader>
          <ModalCloseButton onClick={props.handleClose} hidden={false} />
        </ModalHeader>
...
export const ModalCloseButton: React.FC<ModalButtonProps> = ({ onClick, hidden }) => {
  return (
    <button onClick={onClick} hidden={hidden}>
